	...
	switch(  event.type  ) {
		...
		case SDL_KEYDOWN: {
			...
			switch(  sym  ) {
				...
				case SDLK_KP_0:       code = SIM_KEY_NUMPAD_BASE+0;         break;
				case SDLK_KP_1:       code = SIM_KEY_NUMPAD_BASE+1;         break;
				case SDLK_KP_2:       code = SIM_KEY_NUMPAD_BASE+2;         break;
				case SDLK_KP_3:       code = SIM_KEY_NUMPAD_BASE+3;         break;
				case SDLK_KP_4:       code = SIM_KEY_NUMPAD_BASE+4;         break;
				case SDLK_KP_5:       code = SIM_KEY_NUMPAD_BASE+5;         break;
				case SDLK_KP_6:       code = SIM_KEY_NUMPAD_BASE+6;         break;
				case SDLK_KP_7:       code = SIM_KEY_NUMPAD_BASE+7;         break;
				case SDLK_KP_8:       code = SIM_KEY_NUMPAD_BASE+8;         break;
				case SDLK_KP_9:       code = SIM_KEY_NUMPAD_BASE+9;         break;
